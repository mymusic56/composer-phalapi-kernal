...
class FileConfig implements Config {
	...
	private function loadConfig($fileName) {
        ...
        if(is_file($this->path . DIRECTORY_SEPARATOR . "local/" .$fileName . '.php')){
            $file = 'local'.DIRECTORY_SEPARATOR;
        }elseif(is_file($this->path . DIRECTORY_SEPARATOR . "dev/" .$fileName . '.php')){
            $file = 'dev'.DIRECTORY_SEPARATOR;
        }else{
            $file = 'prod'.DIRECTORY_SEPARATOR;
        }
        $config = include( $this->path . DIRECTORY_SEPARATOR .$file.$fileName .'.php');
