...
class WxPayConfig extends \WxPayConfigInterface
{
    ...
    {
        return \PhalApi\DI()->config->get('app.WeixinPay.mch_id');
    }
    ...
    {
        return  \PhalApi\DI()->config->get('app.WeixinPay.mch_key');
    }
    ...
    {
        $sslCertPath =\PhalApi\DI()->config->get('app.WeixinPay.apiclient_cert');
        $sslKeyPath =\PhalApi\DI()->config->get('app.WeixinPay.apiclient_key');
    }
}
