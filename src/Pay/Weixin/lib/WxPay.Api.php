<?php
use PhalApi\Logger as Logger;
use PhalApi\Logger\FileLogger as FileLogger;
...
class WxPayApi
{
	 ...
	 */
	public static function unifiedOrder($config, $inputObj, $timeOut = 6,&$xml)
	{
	...
	{
        $logger = new FileLogger(API_ROOT . "/runtime/weixinPay", Logger::LOG_LEVEL_DEBUG | Logger::LOG_LEVEL_INFO | Logger::LOG_LEVEL_ERROR);
        $logger->info('发起支付，请求的数据', $xml);
